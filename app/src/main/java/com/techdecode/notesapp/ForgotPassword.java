...
public class ForgotPassword extends AppCompatActivity {
    ...
    private Button mpasswordcoverbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mpasswordcoverbutton=findViewById(R.id.passwordrecoverbutton);
        ...
        mpasswordcoverbutton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
